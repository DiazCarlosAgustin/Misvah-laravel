            ...
            <div class="form-registrarse text-left">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="d-campos py-1">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" name="name" required autocomplete="name" autofocus>
                        @error('name')
                    ...
                    <div class="d-campos py-1">
                        ...
                        <input class="form-control mb-2 @error('telefono') is-invalid @enderror" type="tel" name="telefono" id="telefono" value="{{ old('telefono') }}" autocomplete="telefono">
                    </div>
                    <div class="d-campos py-1">
